...
export interface ApiCarCar extends Schema.CollectionType {
	...
	attributes: {
		...
		minMinuteRate: Attribute.Float & Attribute.Required
		isNew: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>
		isWrapped: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>
		isHot: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>
		sideImages: Attribute.Component<'car-info.side-image', true>
		kmCost: Attribute.Float
		minutes: Attribute.Component<'rate-types.minutes', true> &
			Attribute.Required &
			Attribute.SetMinMax<{
				min: 2
				max: 2
			}>
		rate: Attribute.Relation<'api::car.car', 'manyToOne', 'api::rate.rate'>
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
...
export interface ApiCarFeatureCarFeature extends Schema.SingleType {
	collectionName: 'car_features'
	info: {
		singularName: 'car-feature'
		pluralName: 'car-features'
		displayName: 'CarFeature'
		description: ''
	}
	options: {
		draftAndPublish: true
	...
	attributes: {
		...
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
		createdBy: Attribute.Relation<'api::car-feature.car-feature', 'oneToOne', 'admin::user'> &
			Attribute.Private
		updatedBy: Attribute.Relation<'api::car-feature.car-feature', 'oneToOne', 'admin::user'> &
			Attribute.Private
	}
}
...
export interface ApiHintHint extends Schema.CollectionType {
	...
	attributes: {
		hintType: Attribute.Enumeration<['HINT', 'INSTRUCTION', 'FRIENDSHIP_RULE']> &
			Attribute.Required
		hintName: Attribute.String &
			Attribute.Required &
			Attribute.SetMinMaxLength<{
				maxLength: 40
			}>
...
export interface ApiRateRate extends Schema.CollectionType {
	...
	attributes: {
		rateName: Attribute.String & Attribute.Required
		cars: Attribute.Relation<'api::rate.rate', 'oneToMany', 'api::car.car'>
		ratesWithConditions: Attribute.Component<'rates-info.rate-types-with-conditions', true>
		createdAt: Attribute.DateTime
		updatedAt: Attribute.DateTime
		publishedAt: Attribute.DateTime
...
declare module '@strapi/types' {
	export module Shared {
		export interface ContentTypes {
			...
			'api::car-feature.car-feature': ApiCarFeatureCarFeature
